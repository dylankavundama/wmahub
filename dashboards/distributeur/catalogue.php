...
// Récupérer tous les projets du distributeur
...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="flex-1">
            ...
            <a href="catalogue.php" class="nav-link active"><i class="fas fa-compact-disc"></i> Mon Catalogue</a>
    ...
    <main class="main-content">
        <header class="mb-12">
            <h2 class="text-4xl font-black tracking-tighter">Mon <span class="text-orange-500">Catalogue</span></h2>
            <p class="text-gray-400 mt-2">Suivez les performances et les revenus de tous vos projets.</p>
        </header>
                ...
                <table class="w-full text-left border-collapse">
                    <thead class="bg-white/5">
                        <tr>
                            ...
                            <th class="p-6 text-[10px] text-gray-500 font-bold uppercase tracking-widest">Date</th>
                            <th class="p-6 text-[10px] text-gray-500 font-bold uppercase tracking-widest">Statut</th>
                    ...
                    <tbody class="divide-y divide-white/5">
                        <?php foreach ($projects as $p): ?>
                            <tr class="project-row">
                                ...
                                <td class="p-6">
                                    <p class="text-xs text-gray-500"><?= date('d/m/Y', strtotime($p['created_at'])) ?></p>
                                </td>
                                <td class="p-6">
                                    <?php
                                    $statusClass = 'text-gray-500 bg-gray-500/10';
                                    if ($p['status'] === 'distribue') $statusClass = 'text-green-500 bg-green-500/10';
                                    if ($p['status'] === 'en_preparation') $statusClass = 'text-blue-500 bg-blue-500/10';
                                    ?>
                                    <span class="px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest <?= $statusClass ?>">
                        ...
                        <?php if (empty($projects)): ?>
                            <tr>
                                <td colspan="6" class="p-24 text-center text-gray-500 italic">Aucun projet trouvé dans votre catalogue.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
