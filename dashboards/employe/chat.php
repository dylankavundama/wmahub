...
<head>
    ...
    <title>WMA STAFF - Chat Équipe</title>
...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="flex-1">
            ...
            <a href="chat.php" class="nav-link active"><i class="fas fa-comments"></i> Chat Équipe</a>
    ...
    <div class="chat-area">
        <header class="p-6 border-b border-white/5 flex items-center justify-between">
            <div>
                ...
                <p class="text-[10px] text-orange-500 font-black uppercase tracking-widest">Global Support & Staff</p>
            </div>
