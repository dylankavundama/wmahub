...
<head>
    ...
    <title>WMA STAFF - Notifications</title>
...
<body>
    ...
    <main class="main-content">
        <header class="flex items-center justify-between mb-12">
            <div>
                ...
                <p class="text-gray-400 mt-2">Historique complet de vos alertes.</p>
            </div>
    ...
    <script>
        ...
        function getText(n) {
            switch(n.type) {
                case 'new_task': return 'Une nouvelle tâche vous a été assignée par l\'administration.';
                case 'new_message': return 'Vous avez reçu un message privé.';
                case 'new_broadcast_message': return 'Nouveau message dans le chat d\'équipe.';
                default: return 'Alerte système staff.';
            }
        }
