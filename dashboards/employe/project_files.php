...
<head>
    ...
    <title>WMA STAFF - Fichier Projet</title>
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="flex-1">
            ...
            <a href="missions.php" class="nav-link"><i class="fas fa-tasks"></i> Mes Missions</a>
    ...
    <main class="main-content">
        <header class="p-8 border-b border-white/5 flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
                ...
                <p class="text-[10px] text-orange-500 font-black uppercase tracking-widest">Espace collaboratif Staff & Admin</p>
            </div>
        ...
        <div class="glass-panel w-full max-w-lg p-8">
            ...
            <form id="uploadForm" class="space-y-6">
                <div>
                    ...
                    <input type="text" name="title" required class="custom-input" placeholder="Ex: Rapport Hebdomadaire">
                </div>
                <div>
                    <label class="block text-[10px] font-black uppercase text-orange-500 mb-2 tracking-widest">Description (facultative)</label>
                    <textarea name="description" class="custom-input h-24 resize-none" placeholder="Précisions sur le fichier..."></textarea>
                </div>
                <div>
                    ...
                    <p class="text-[9px] text-gray-500 mt-2 italic">Formats pros acceptés (PDF, DOCX, MP3...).</p>
                </div>
    ...
    <script>
            ...
            try {
                ...
                if (data.success) {
                    ...
                    data.files.forEach(file => {
                        ...
                        const isOwner = file.sender_id == <?= $_SESSION['user_id'] ?>;
        ...
        uploadForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                const btn = uploadForm.querySelector('button[type="submit"]');
                btn.disabled = false;
                btn.innerHTML = 'Partager maintenant';
            }
        });
