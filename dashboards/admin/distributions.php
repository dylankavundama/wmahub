...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav>
            <a href="index.php" class="nav-link"><i class="fas fa-layer-group"></i> Dashboard</a>
            <a href="distributions.php" class="nav-link active"><i class="fas fa-music"></i> Distributions</a>
            <a href="hero_slider.php" class="nav-link"><i class="fas fa-images"></i> Slider</a>
        </nav>
    </aside>
