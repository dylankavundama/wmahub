...
<head>
    ...
    <style>
        ...
        .glass-card { background: rgba(255, 255, 255, 0.03); backdrop-filter: blur(10px); border: 1px solid rgba(255, 255, 255, 0.05); border-radius: 20px; transition: all 0.3s ease; padding: 24px; }
        ...
        textarea { width: 100%; height: 300px; background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.05); border-radius: 16px; padding: 16px; color: #fff; resize: none; transition: all 0.3s ease; }
        textarea:focus { outline: none; border-color: #ff6600; background: rgba(255, 255, 255, 0.05); box-shadow: 0 0 20px rgba(255, 102, 0, 0.1); }
        .btn-submit { width: 100%; padding: 16px; background: linear-gradient(135deg, #ff6600 0%, #ff8c00 100%); color: #fff; border-radius: 16px; font-weight: 700; text-transform: uppercase; letter-spacing: 1px; transition: all 0.3s ease; display: flex; align-items: center; justify-content: center; gap: 10px; }
        .btn-submit:hover { transform: translateY(-2px); box-shadow: 0 10px 20px rgba(255, 102, 0, 0.2); }
...
<body>
    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 p-6 lg:p-12">
            <header class="mb-12">
                <a href="services.php" class="text-orange-500/60 hover:text-orange-500 font-bold text-[10px] uppercase tracking-widest transition-all mb-4 inline-block"><i class="fas fa-arrow-left mr-2"></i>Retour</a>
                <h2 class="text-4xl lg:text-5xl font-black mb-2 tracking-tighter text-white">Correction <span class="text-orange-500 text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-600">Intelligente</span></h2>
                <p class="text-gray-500 font-medium">Polissez vos textes avec la précision d'un éditeur professionnel.</p>
            </header>
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-8">
                <div class="glass-card">
                    ...
                    <div class="mt-6">
                        <button id="correctBtn" class="btn-submit text-xs tracking-widest">
                ...
                <div class="glass-card">
                    ...
                    <div id="correctedResult" class="result-box-glass italic min-h-[300px] text-gray-500">
                        Le résultat apparaîtra ici après correction...
                    </div>
                    <div class="mt-6 flex gap-4">
                        <button id="copyBtn" class="flex-1 py-4 bg-white/5 hover:bg-white/10 rounded-xl font-bold text-[10px] uppercase tracking-widest border border-white/5 transition-all hidden flex items-center justify-center gap-2">
                            <i class="fas fa-copy text-orange-500"></i> Copier
                        </button>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        correctBtn.onclick = async () => {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    correctedResult.scrollIntoView({ behavior: 'smooth', block: 'start' });
                } else {
        ...
        copyBtn.onclick = () => {
            ...
            copyBtn.innerHTML = '<i class="fas fa-check text-green-500"></i> Copié !';
            setTimeout(() => {
